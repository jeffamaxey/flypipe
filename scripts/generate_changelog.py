...
for commit_id in commit_list:
    ...
    if re_match := re.search(RE_GITHUB_ISSUE, commit_message_summary):
        print(
            f'Found github issue {re_match[0]} in commit msg summary {commit_message_summary}'
        )
        issue_id = re_match[0][1:]
